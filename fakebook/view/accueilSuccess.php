<div class="wrapper"><!-- Author : DAUDEL Adrien -->
		...
		<div class="main main-raised">
			<div class="profile-content">
				<div class="container">
					<div class="row">
						<div class="col-lg-3 col-md-3 col-xs-3 col-sm-3" id="profile-card">
							<img class="img-rounded img-responsive img-raised" style="max-height : 150px; max-width : 200px;" src="<?php echo context::getSessionAttribute('avatar'); ?>" alt="votre avatar">
							<div class="caption">
